...
<section id="section-slider" class="about_bg">
    ...
    <div class="first_message_holder">
        ...
        <h4 class="opensan text-center f2">The strong and resilient property market in Dubai demands professionalism,
            knowledge, and commitment. At D&B
            Properties, we have proven track record of excelling in all of them. Over the years, we have been catering
            to
