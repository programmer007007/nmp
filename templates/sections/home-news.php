            ...
            <div class="col">
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('card border-0'); ?> >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-2"><small><?php the_category(', '); ?>
                        ...
                        <a href="<?php the_permalink(); ?>">
                            <img class="img-fluid pb-3" src="<?php the_post_thumbnail_url('brk_single'); ?>"
                        ...
                        <a href="<?php the_permalink(); ?>"
                           class="card-link"><?php esc_html_e('Read more', 'bricks'); ?></a>
