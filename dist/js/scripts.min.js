(function (factory) {
  ...
  // --- Back to Top ---
  var html$2 = document.querySelector('html');
  var backToTop = document.querySelector('#backtotop');

  if (backToTop) {
    document.addEventListener('scroll', function () {
      if (html$2.scrollTop > 200) {
  ...
  ***************************************************************************** */
  ...
  function () {
    ...
    LightGallery.prototype.openGallery = function (index, element) {
      ...
      this.index = index;
      this.LGel.trigger(lGEvents$2.beforeOpen); // add class lg-current to remove initial transition
    ...
    LightGallery.prototype.loadContent = function (index, rec) {
      ...
      if (!$currentSlide.hasClass('lg-loaded')) {
        ...
        this.LGel.trigger(lGEvents$2.afterAppendSlide, {
          index: index
        });
  ...
  const modules = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom$1, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Thumb, freeMode, Grid, Manipulation, EffectFade, EffectCube, EffectFlip, EffectCoverflow, EffectCreative, EffectCards];
  Swiper.use(modules);
  ...
  ***************************************************************************** */
  ...
  var jquery_validate_min = {exports: {}};
  ...
  (function (module) {
  !function (a) {
    module.exports ? module.exports = a(jquery.exports) : a(jQuery);
  }(function (a) {
    a.extend(a.fn, {
      validate: function (b) {
  ...
  $$1(document).ready(function ($) {
    ...
    var ajaxCall = function ajaxCall(type, data, callback) {
      jQuery.ajax({
        type: type,
        url: window.ajaxurl,
        dataType: 'JSON',
    ...
    var successElement = $('#form-message-success');
    var warningElement = $('#form-message-warning');
    var contactFormElement = $('#contactForm');
    warningElement.hide();
    successElement.hide();
    ...
    contactForm();
    var floatingContactFormElement = $('#floatingcontactForm');

    var floatingContactForm = function floatingContactForm() {
    ...
    floatingContactForm();
    var successSubscriberElement = $('#form-message-subcriber-success');
    var warningSubscriberElement = $('#form-message-subcriber-warning');
    warningSubscriberElement.hide();
    successSubscriberElement.hide();
    var subscriberFormElement = $('#subcribeForm');

    var subcribeMainForm = function subcribeMainForm() {
    ...
    $('.readmore-link').click(function (e) {
      ...
      var isExpanded = $(e.target).hasClass('expand'); // close all open paragraphs

      $('.readmore.expand').removeClass('expand');
      $('.readmore-link.expand').removeClass('expand'); // if target wasn't expand, then expand it
