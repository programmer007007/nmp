(function (factory) {
  ...
  ***************************************************************************** */
  ...
  $(document).ready(function ($) {
    ...
    if ($("#v").length) {
      var video_height = document.getElementById("v").offsetHeight;
      var m_top1 = document.getElementById("main_first_top").offsetHeight;
      var m_top2 = document.getElementById("header-wrapper").offsetHeight;
      var start_from = m_top1 + m_top2; // if (screenWidth >= 426) {
